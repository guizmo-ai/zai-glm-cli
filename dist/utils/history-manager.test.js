...
describe("HistoryManager", () => {
    ...
    beforeEach(() => {
        ...
        originalHistoryPath = manager.historyPath;
        manager.historyPath = testHistoryPath;
    });
    afterEach(() => {
        // Clean up test files
    ...
    describe("Search", () => {
        ...
        it("should search by fuzzy match", () => {
            const manager = HistoryManager.getInstance();
            const results = manager.search({ query: "npmt", fuzzy: true });
        ...
        it("should filter by working directory", () => {
            ...
            expect(results).toHaveLength(2);
            expect(results.every((r) => r.workingDirectory === "/project2")).toBe(true);
        });
    ...
    describe("Import/Export", () => {
        it("should export history to file", () => {
            ...
            manager.addEntry("command2");
            const exportPath = path.join(path.dirname(testHistoryPath), "export.json");
        ...
        it("should import history from file (append)", () => {
            ...
            const importPath = path.join(path.dirname(testHistoryPath), "import.json");
